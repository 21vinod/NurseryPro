...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_GET['del'])) {
        ...
        header('location:manage-approvals.php');
    ...
    <head>
        ...
        <title>NurseryPro | Manage Approvals</title>
                                                ...
                                                foreach ($results as $result) {
                                                    ...
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td class="center" width="300">
                                                            <img src="img/<?php echo htmlentities($result->bookImage); ?>"
                                                                width="100">
                                                            <br /><b>
                                                        ...
                                                        <td class="center">
                                                            ...
                                                            <a
                                                                href="edit-approval.php?bookid=<?php echo htmlentities($result->bookid); ?>"><button
                                                                    class="btn btn-primary"><i class="fa fa-edit "></i>
                                                                    Edit</button> </a>
                                                            <a href="manage-approvals.php?del=<?php echo htmlentities($result->bookid); ?>"
