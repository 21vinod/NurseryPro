                                            ...
                                            if ($query->rowCount() > 0) {
                                                foreach ($results as $result) { ?>
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td class="center">
                                                            <?php if ($result->Status == 1) { ?>
                                                                <a href="reg-users.php?inid=<?php echo htmlentities($result->id); ?>"
                                                                    onclick="return confirm('Are you sure you want to block this User?');">
                                                                    <button class="btn btn-danger"> Inactive</button>
                                                                <?php } else { ?>

                                                                    <a href="reg-users.php?id=<?php echo htmlentities($result->id); ?>"
                                                                        onclick="return confirm('Are you sure you want to active this User?');"><button
                                                                            class="btn btn-primary"> Active</button>
                                                                    <?php } ?>

                                                                    <a
                                                                        href="User-history.php?stdid=<?php echo htmlentities($result->user_id); ?>"><button
